...
//  //--- 16 Bit Error Code
//
//  Error Code Numbers are Signed Decimal Values
//  Error Code Numbers 1 to 32767 represent errors returned by Tasks to the dispatcher
//  Error Code Numbers < 0 represent system level errors either Operating System or Hardware
//  The actual user code Error Code Values are defined by the program creator
//
//  All Errors fall into ONE of these 16 classes
//  System Error Classes:
//  (-1 to -2)                                    //--- Error Class Codes for System Errors
...
//
//  Error Codes developed from Drivers should be defined within the Driver Code Blocks
//  or interrupt handeling code blocks
//
//---------------------------------------------------------------------------------------------
