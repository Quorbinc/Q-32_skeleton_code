...
#  Do Not use Thumb Interwork
#THUMB_IW = -mno-thumb-interwork
...
#
# if you are using the CMSIS startup assembly source file then uncomment the
# following definition:

# ASRC = stm32l432_start.s
...
CFLAGS += -Wall -Wimplicit -Wunused-but-set-variable
