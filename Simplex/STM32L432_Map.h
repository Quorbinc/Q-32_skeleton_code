...
//  #endif
  ...
  typedef struct
  {
    ...
    __IOM u32 ICSR;                   //---   Offset: 0x004 (R/W)  Interrupt Control and State Register
    __IOM u32 VTOR;                   //---   Offset: 0x008 (R/W)  Vector Table Offset Register
    __IOM u32 AIRCR;                  //---   Offset: 0x00C (R/W)  Application Interrupt and Reset Control Register
    __IOM u32 SCR;                    //---   Offset: 0x010 (R/W)  System Control Register
    __IOM u32 CCR;                    //---   Offset: 0x014 (R/W)  Configuration Control Register
    __IOM u08 SHP[12U];               //---   Offset: 0x018 (R/W)  System Handlers Priority Registers (4-7, 8-11, 12-15)
    __IOM u32 SHCSR;                  //---   Offset: 0x024 (R/W)  System Handler Control and State Register
    __IOM u32 CFSR;                   //---   Offset: 0x028 (R/W)  Configurable Fault Status Register
    __IOM u32 HFSR;                   //---   Offset: 0x02C (R/W)  HardFault Status Register
    __IOM u32 DFSR;                   //---   Offset: 0x030 (R/W)  Debug Fault Status Register
    __IOM u32 MMFAR;                  //---   Offset: 0x034 (R/W)  MemManage Fault Address Register
    __IOM u32 BFAR;                   //---   Offset: 0x038 (R/W)  BusFault Address Register
    __IOM u32 AFSR;                   //---   Offset: 0x03C (R/W)  Auxiliary Fault Status Register
    __IM  u32 PFR[2U];                //---   Offset: 0x040 (R/ )  Processor Feature Register
    __IM  u32 DFR;                    //---   Offset: 0x048 (R/ )  Debug Feature Register
    __IM  u32 ADR;                    //---   Offset: 0x04C (R/ )  Auxiliary Feature Register
    __IM  u32 MMFR[4U];               //---   Offset: 0x050 (R/ )  Memory Model Feature Register
    __IM  u32 ISAR[5U];               //---   Offset: 0x060 (R/ )  Instruction Set Attributes Register
          u32 RESERVED0[5U];
    __IOM u32 CPACR;                  //---   Offset: 0x088 (R/W)  Coprocessor Access Control Register
  }  SCB_Type;

  #define SCB               ((SCB_Type*) SCB_BASE)        //--- NVIC configuration struct
  ...
  #define SCB_SHP           *(vu32*)(SCB_BASE + 0x0018U)  //--- System Handler Priority (4,5,6)
  ...
  typedef struct
  {
    vu32  ISER[8U];               //---   0x000 (R/W)  Interrupt Set Enable Register
    u32   RESERVED0[24U];
    vu32  ICER[8U];               //---   0x080 (R/W)  Interrupt Clear Enable Register
    u32   RSERVED1[24U];
    vu32  ISPR[8U];               //---   0x100 (R/W)  Interrupt Set Pending Register
    u32   RESERVED2[24U];
    vu32  ICPR[8U];               //---   0x180 (R/W)  Interrupt Clear Pending Register
    u32   RESERVED3[24U];
    vu32  IABR[8U];               //---   0x200 (R/W)  Interrupt Active bit Register
    u32   RESERVED4[56U];
    vu08  IP[240U];               //---   0x300 (R/W)  Interrupt Priority Register (8Bit wide)
    u32   RESERVED5[644U];
    vu32  STIR;                   //---   0xE00 ( /W)  Software Trigger Interrupt Register
  }  NVIC_Type;
  ...
  #define NVIC_IPRI_BYTES       (NVIC_BASE + 0x00000300)
  #define NVIC_IP               (NVIC_BASE + 0x00000300)
 ...
 //-------------------------------------------------------------------------------------------
  ...
  //-------------------------------------------------------------------------------------------
  //--- Timer #1 registers
  #define TIM1_CR1              *(vu16 *)(TIM1_BASE + 0x00000000)
  #define TIM1_CR2              *(vu16 *)(TIM1_BASE + 0x00000004)
  #define TIM1_SMCR             *(vu16 *)(TIM1_BASE + 0x00000008)
  #define TIM1_DIER             *(vu16 *)(TIM1_BASE + 0x0000000C)
  #define TIM1_SR               *(vu16 *)(TIM1_BASE + 0x00000010)
  #define TIM1_EGR              *(vu16 *)(TIM1_BASE + 0x00000014)
  #define TIM1_CCMR1            *(vu16 *)(TIM1_BASE + 0x00000018)
  #define TIM1_CCMR2            *(vu16 *)(TIM1_BASE + 0x0000001C)
  #define TIM1_CCER             *(vu16 *)(TIM1_BASE + 0x00000020)
  #define TIM1_CNT              *(vu16 *)(TIM1_BASE + 0x00000024)
  #define TIM1_PSC              *(vu16 *)(TIM1_BASE + 0x00000028)
  #define TIM1_ARR              *(vu16 *)(TIM1_BASE + 0x0000002C)
  #define TIM1_RCR              *(vu16 *)(TIM1_BASE + 0x00000030)
  #define TIM1_CCR1             *(vu16 *)(TIM1_BASE + 0x00000034)
  #define TIM1_CCR2             *(vu16 *)(TIM1_BASE + 0x00000038)
  #define TIM1_CCR3             *(vu16 *)(TIM1_BASE + 0x0000003C)
  #define TIM1_CCR4             *(vu16 *)(TIM1_BASE + 0x00000040)
  #define TIM1_BDTR             *(vu16 *)(TIM1_BASE + 0x00000044)
  #define TIM1_DCR              *(vu16 *)(TIM1_BASE + 0x00000048)
  #define TIM1_DMAR             *(vu16 *)(TIM1_BASE + 0x0000004C)

  //--- Timer #2 registers
  #define TIM2_CR1              *(vu16 *)(TIM2_BASE + 0x00000000)
  #define TIM2_CR2              *(vu16 *)(TIM2_BASE + 0x00000004)
  #define TIM2_SMCR             *(vu32 *)(TIM2_BASE + 0x00000008)
  #define TIM2_DIER             *(vu16 *)(TIM2_BASE + 0x0000000C)
  #define TIM2_SR               *(vu16 *)(TIM2_BASE + 0x00000010)
  #define TIM2_EGR              *(vu16 *)(TIM2_BASE + 0x00000014)
  #define TIM2_CCMR1            *(vu32 *)(TIM2_BASE + 0x00000018)
  #define TIM2_CCMR2            *(vu32 *)(TIM2_BASE + 0x0000001C)
  #define TIM2_CCER             *(vu16 *)(TIM2_BASE + 0x00000020)
  #define TIM2_CNT              *(vu32 *)(TIM2_BASE + 0x00000024)
  #define TIM2_PSC              *(vu16 *)(TIM2_BASE + 0x00000028)
  #define TIM2_ARR              *(vu16 *)(TIM2_BASE + 0x0000002C)
  ...
  #define TIM2_DCR              *(vu16 *)(TIM2_BASE + 0x00000048)
  #define TIM2_DMAR             *(vu16 *)(TIM2_BASE + 0x0000004C)

  //--- Timer #3 registers
  #define TIM3_CR1              *(vu16 *)(TIM3_BASE + 0x00000000)
  #define TIM3_CR2              *(vu16 *)(TIM3_BASE + 0x00000004)
  #define TIM3_SMCR             *(vu16 *)(TIM3_BASE + 0x00000008)
  #define TIM3_DIER             *(vu16 *)(TIM3_BASE + 0x0000000C)
  #define TIM3_SR               *(vu16 *)(TIM3_BASE + 0x00000010)
  #define TIM3_EGR              *(vu16 *)(TIM3_BASE + 0x00000014)
  #define TIM3_CCMR1            *(vu16 *)(TIM3_BASE + 0x00000018)
  #define TIM3_CCMR2            *(vu16 *)(TIM3_BASE + 0x0000001C)
  #define TIM3_CCER             *(vu16 *)(TIM3_BASE + 0x00000020)
  #define TIM3_CNT              *(vu16 *)(TIM3_BASE + 0x00000024)
  #define TIM3_PSC              *(vu16 *)(TIM3_BASE + 0x00000028)
  #define TIM3_ARR              *(vu16 *)(TIM3_BASE + 0x0000002C)
  #define TIM3_CCR1             *(vu16 *)(TIM3_BASE + 0x00000034)
  #define TIM3_CCR2             *(vu16 *)(TIM3_BASE + 0x00000038)
  #define TIM3_CCR3             *(vu16 *)(TIM3_BASE + 0x0000003C)
  #define TIM3_CCR4             *(vu16 *)(TIM3_BASE + 0x00000040)
  #define TIM3_DCR              *(vu16 *)(TIM3_BASE + 0x00000048)
  #define TIM3_DMAR             *(vu16 *)(TIM3_BASE + 0x0000004C)

  //--- Timer #6 registers
  #define TIM6_CR1              *(vu16 *)(TIM6_BASE + 0x00000000)
  #define TIM6_CR2              *(vu16 *)(TIM6_BASE + 0x00000004)
  #define TIM6_SMCR             *(vu16 *)(TIM6_BASE + 0x00000008)
  #define TIM6_DIER             *(vu16 *)(TIM6_BASE + 0x0000000C)
  #define TIM6_SR               *(vu16 *)(TIM6_BASE + 0x00000010)
  #define TIM6_EGR              *(vu16 *)(TIM6_BASE + 0x00000014)
  #define TIM6_CCMR1            *(vu16 *)(TIM6_BASE + 0x00000018)
  #define TIM6_CCMR2            *(vu16 *)(TIM6_BASE + 0x0000001C)
  #define TIM6_CCER             *(vu16 *)(TIM6_BASE + 0x00000020)
  #define TIM6_CNT              *(vu16 *)(TIM6_BASE + 0x00000024)
  #define TIM6_PSC              *(vu16 *)(TIM6_BASE + 0x00000028)
  #define TIM6_ARR              *(vu16 *)(TIM6_BASE + 0x0000002C)
  #define TIM6_CCR1             *(vu16 *)(TIM6_BASE + 0x00000034)
  #define TIM6_CCR2             *(vu16 *)(TIM6_BASE + 0x00000038)
  #define TIM6_CCR3             *(vu16 *)(TIM6_BASE + 0x0000003C)
  #define TIM6_CCR4             *(vu16 *)(TIM6_BASE + 0x00000040)
  #define TIM6_DCR              *(vu16 *)(TIM6_BASE + 0x00000048)
  #define TIM6_DMAR             *(vu16 *)(TIM6_BASE + 0x0000004C)

  //--- Timer #7 registers
  #define TIM7_CR1              *(vu16 *)(TIM7_BASE + 0x00000000)
  #define TIM7_CR2              *(vu16 *)(TIM7_BASE + 0x00000004)
  #define TIM7_SMCR             *(vu16 *)(TIM7_BASE + 0x00000008)
  #define TIM7_DIER             *(vu16 *)(TIM7_BASE + 0x0000000C)
  #define TIM7_SR               *(vu16 *)(TIM7_BASE + 0x00000010)
  #define TIM7_EGR              *(vu16 *)(TIM7_BASE + 0x00000014)
  #define TIM7_CCMR1            *(vu16 *)(TIM7_BASE + 0x00000018)
  #define TIM7_CCMR2            *(vu16 *)(TIM7_BASE + 0x0000001C)
  #define TIM7_CCER             *(vu16 *)(TIM7_BASE + 0x00000020)
  #define TIM7_CNT              *(vu16 *)(TIM7_BASE + 0x00000024)
  #define TIM7_PSC              *(vu16 *)(TIM7_BASE + 0x00000028)
  #define TIM7_ARR              *(vu16 *)(TIM7_BASE + 0x0000002C)
  #define TIM7_CCR1             *(vu16 *)(TIM7_BASE + 0x00000034)
  #define TIM7_CCR2             *(vu16 *)(TIM7_BASE + 0x00000038)
  #define TIM7_CCR3             *(vu16 *)(TIM7_BASE + 0x0000003C)
  #define TIM7_CCR4             *(vu16 *)(TIM7_BASE + 0x00000040)
  #define TIM7_DCR              *(vu16 *)(TIM7_BASE + 0x00000048)
  #define TIM7_DMAR             *(vu16 *)(TIM7_BASE + 0x0000004C)

  //--- Timer #15 registers
  #define TIM15_CR1             *(vu16 *)(TIM15_BASE + 0x00000000)
  #define TIM15_CR2             *(vu16 *)(TIM15_BASE + 0x00000004)
  #define TIM15_SMCR            *(vu16 *)(TIM15_BASE + 0x00000008)
  #define TIM15_DIER            *(vu16 *)(TIM15_BASE + 0x0000000C)
  #define TIM15_SR              *(vu16 *)(TIM15_BASE + 0x00000010)
  #define TIM15_EGR             *(vu16 *)(TIM15_BASE + 0x00000014)
  #define TIM15_CCMR1           *(vu16 *)(TIM15_BASE + 0x00000018)
  #define TIM15_CCMR2           *(vu16 *)(TIM15_BASE + 0x0000001C)
  #define TIM15_CCER            *(vu16 *)(TIM15_BASE + 0x00000020)
  #define TIM15_CNT             *(vu16 *)(TIM15_BASE + 0x00000024)
  #define TIM15_PSC             *(vu16 *)(TIM15_BASE + 0x00000028)
  #define TIM15_ARR             *(vu16 *)(TIM15_BASE + 0x0000002C)
  #define TIM15_RCR             *(vu16 *)(TIM15_BASE + 0x00000030)
  #define TIM15_CCR1            *(vu16 *)(TIM15_BASE + 0x00000034)
  #define TIM15_CCR2            *(vu16 *)(TIM15_BASE + 0x00000038)
  #define TIM15_CCR3            *(vu16 *)(TIM15_BASE + 0x0000003C)
  #define TIM15_CCR4            *(vu16 *)(TIM15_BASE + 0x00000040)
  #define TIM15_BDTR            *(vu16 *)(TIM15_BASE + 0x00000044)
  #define TIM15_DCR             *(vu16 *)(TIM15_BASE + 0x00000048)
  #define TIM15_DMAR            *(vu16 *)(TIM15_BASE + 0x0000004C)

  //--- Timer #16 registers
  #define TIM16_CR1             *(vu16 *)(TIM16_BASE + 0x00000000)
  #define TIM16_CR2             *(vu16 *)(TIM16_BASE + 0x00000004)
  #define TIM16_SMCR            *(vu16 *)(TIM16_BASE + 0x00000008)
  #define TIM16_DIER            *(vu16 *)(TIM16_BASE + 0x0000000C)
  #define TIM16_SR              *(vu16 *)(TIM16_BASE + 0x00000010)
  #define TIM16_EGR             *(vu16 *)(TIM16_BASE + 0x00000014)
  #define TIM16_CCMR1           *(vu16 *)(TIM16_BASE + 0x00000018)
  #define TIM16_CCMR2           *(vu16 *)(TIM16_BASE + 0x0000001C)
  #define TIM16_CCER            *(vu16 *)(TIM16_BASE + 0x00000020)
  #define TIM16_CNT             *(vu16 *)(TIM16_BASE + 0x00000024)
  #define TIM16_PSC             *(vu16 *)(TIM16_BASE + 0x00000028)
  #define TIM16_ARR             *(vu16 *)(TIM16_BASE + 0x0000002C)
  #define TIM16_RCR             *(vu16 *)(TIM16_BASE + 0x00000030)
  #define TIM16_CCR1            *(vu16 *)(TIM16_BASE + 0x00000034)
  #define TIM16_CCR2            *(vu16 *)(TIM16_BASE + 0x00000038)
  #define TIM16_CCR3            *(vu16 *)(TIM16_BASE + 0x0000003C)
  #define TIM16_CCR4            *(vu16 *)(TIM16_BASE + 0x00000040)
  #define TIM16_BDTR            *(vu16 *)(TIM16_BASE + 0x00000044)
  #define TIM16_DCR             *(vu16 *)(TIM16_BASE + 0x00000048)
  #define TIM16_DMAR            *(vu16 *)(TIM16_BASE + 0x0000004C)
