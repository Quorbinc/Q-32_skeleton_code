...
//--- Mulitdefine trap
  ...
  //--- Clock Time Structure Used for Time Stamps
  struct TimeDate                 //--- 10 Bytes
  {
    ...
    u16   uwMsec;                 //--- Milli Seconds of Second (000 - 999)
  };

  struct TimeDate stUTCTime;
  struct TimeDate stLOCTime;
  struct TimeDate stSIDTime;
  struct TimeDate stJULTime;

  struct TimeDate fnReadRTCclock (u08 ubType);
  u08    fnSetRTCclock (struct TimeDate stSetTime);
